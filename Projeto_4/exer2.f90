program exer2
        ...
        real(8) :: lambda, dt, t_vida_media_exato, t_vida_media_calc !constante de decaimento e intervalo de tempo
        ...
        t_vida_media_exato = 1.0d0 / lambda
        ...
        do i = 1, int(10.0d0 / dt)
                ...
                t_vida_media_calc = t_vida_media_calc + ((i * dt * atomos_decaidos) / N0)

                N = N - atomos_decaidos
                atomos_decaidos = 0
        end do 

        t_vida_media_calc = t_vida_media_calc + ((10.0d0 * N) / N0)

        write(*,*) t_vida_media_calc, t_vida_media_exato
